...
// vortex: double precision winding
typedef struct
{
	int		numpoints;
	dvec3_t	p[4];
...
void	    FreeDWinding( dwinding_t *w );
dwinding_t *BaseDWindingForPlane( vec3_t normal, vec_t dist, float maxsize );
void	    ChopDWindingInPlace( dwinding_t **dw, vec3_t normal, vec_t dist, vec_t epsilon );
