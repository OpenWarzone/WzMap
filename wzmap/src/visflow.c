...
uint32_t c_fullskip;
extern uint32_t c_portalskip, c_leafskip;
extern uint32_t c_vistest, c_mighttest;

uint32_t c_chop, c_nochop;
...
//	CheckStack (leaf, thread);
	...
	for ( i = 0; i < leaf->numportals; i++ )
	{
		...
		/* MrE: portal trace debug code
		   {
		    uint32_t portaltrace[] = {13, 16, 17, 37};
		    pstack_t *s;
...
/*
   ...
   ===============
 */
void PortalFlow(int portalnumOrig){
	uint32_t portalnum = (uint32_t)portalnumOrig;
	threaddata_t data;
	uint32_t i;
	vportal_t       *p;
...
/*
   ...
   ===============
 */
void PassageFlow(int portalnumOrig){
	uint32_t portalnum = (uint32_t)portalnumOrig;
	threaddata_t data;
	uint32_t i;
	vportal_t       *p;
...
/*
   ...
   ===============
 */
void PassagePortalFlow(int portalnumOrig){
	uint32_t portalnum = (uint32_t)portalnumOrig;
	threaddata_t data;
	uint32_t i;
	vportal_t       *p;
...
/*
   ...
   ===============
 */
uint32_t AddSeperators(fixedWinding_t *source, fixedWinding_t *pass, qboolean flipclip, visPlane_t *seperators, uint32_t maxseperators){
	uint32_t i, j, k, l;
	visPlane_t plane;
	vec3_t v1, v2;
	float d;
...
/*
   ...
   ===============
 */
void CreatePassages(int portalnumOrig){
	uint32_t portalnum = (uint32_t)portalnumOrig;
...
/*
   ...
   ==============
 */
void BasePortalVis(int portalnumOrig){
	uint32_t portalnum = (uint32_t)portalnumOrig;
	uint32_t j, k;
	vportal_t   *tp, *p;
	float d;
...
/*
   ...
   ==============
 */
void BetterPortalVis(int portalnumOrig){
	uint32_t portalnum = (uint32_t)portalnumOrig;
	vportal_t   *p;
